...
public class DataController {
    ...
    @RequestMapping(value = "/data/{id}", consumes = MediaType.ALL_VALUE, method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public RestData get(@PathVariable("id") String id) {
        return DataMapper.toRest(dataBusinessLogic.get(id));
    }

    @RequestMapping(value = "/data", consumes = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/data/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.PUT,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/data/{id}", consumes = MediaType.ALL_VALUE, method = RequestMethod.DELETE)
